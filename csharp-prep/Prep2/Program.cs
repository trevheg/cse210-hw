...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Console.Write("What is your grade percentage as an integer? ");
        ...
        if (gradeRemainder >= 7 && gradeInt > 59 && gradeInt < 95)
        {
            gradeMod = "+";
        }
        else if (gradeRemainder < 3 && gradeInt > 59 && gradeInt < 95)
        {
            gradeMod = "-";
        }
        else
        ...
        Console.WriteLine($"Your grade is {letter}{gradeMod}.");
